# Networking configuration for K8s Vulnerable Database Project
...
# Security Group for Vulnerable Database
resource "aws_security_group" "vulnerable_db" {
  ...
  # MySQL access from allowed CIDR blocks (for demo purposes)
  ingress {
    description = "MySQL External"
    from_port   = 3306
    to_port     = 3306
    protocol    = "tcp"
    cidr_blocks = var.allowed_cidr_blocks
...
# VPC Endpoints for private subnet access to AWS services (optional but recommended)
